...
class Job(models.Model):
    ...
    experience =models.TextField(_('Experience'), max_length=5000, null=True, blank=True)
    ...
    categorie = models.ForeignKey('Categorie', verbose_name=_('Categorie'), related_name='categorie_job', on_delete=models.CASCADE,max_length=5000, null=True, blank=True )
